...
import type {AvailabilityRecord,PriceRecord,ProcessorRecord,ProductionRecord,RoadRouteRecord,RouteRecord,SellerRecord,SurveyRecord} from "./types";
...
export const fonioData={
 ...
 availability:h6.availability as AvailabilityRecord[], survey:h6.survey as SurveyRecord[],
};
